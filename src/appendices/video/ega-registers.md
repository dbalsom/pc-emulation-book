...
{{#bitfield ega_registers.toml#attribute-palette-entry}}

{{#bitfield ega_registers.toml#attribute-mode-control}}


{{#bitfield ega_registers.toml#overscan-color-register}}

{{#bitfield ega_registers.toml#color-plane-enable-register}}

{{#bitfield ega_registers.toml#pel-panning-register}}